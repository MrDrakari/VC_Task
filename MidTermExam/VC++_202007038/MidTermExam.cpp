...
void Draw(HWND hWnd, HDC hdc) {
    ...
    if (drow != 0 && startPoint.x > 16 && startPoint.y > 87 && startPoint.x < 768 && startPoint.y < 426) {
        if (endPoint.x > 16 && endPoint.y > 87 && endPoint.x < 768 && endPoint.y < 426) {
            ...
            //    Ellipse(hdc, centerX - radius, centerY - radius, centerX + radius, centerY + radius); //왼쪽 귀
            //    Ellipse(hdc, centerX - radius, centerY - radius, centerX + radius, centerY + radius); //오른쪽 귀

            //    Ellipse(hdc, centerX - radius, centerY - radius, centerX + radius, centerY + radius); //얼굴
            //    DeleteObject(hBrush);


            //    HBRUSH hBrush = CreateSolidBrush(RGB(255, 25, 255));
            //    SelectObject(hdc, hBrush);
            //    Ellipse(hdc, centerX - radius, centerY - radius, centerX + radius, centerY + radius); //왼쪽 코
            //    Ellipse(hdc, centerX - radius, centerY - radius, centerX + radius, centerY + radius); //오른쪽 코
            //    DeleteObject(hBrush);

            //    HBRUSH hBrush = CreateSolidBrush(RGB(0, 0, 0));
            //    SelectObject(hdc, hBrush);
            //    Ellipse(hdc, centerX - radius, centerY - radius, centerX + radius, centerY + radius); //왼쪽 눈
            //    Ellipse(hdc, centerX - radius, centerY - radius, centerX + radius, centerY + radius); //오른쪽 눈

            //    MoveToEx(hdc, right + (left - right) / 6, top, NULL); //왼쪽 눈썹
            ...
            //    MoveToEx(hdc, right + (left - right) / 6, top, NULL); //오른쪽 눈썹
            //    LineTo(hdc, right + (left - right) / 6, bottom);
            //    MoveToEx(hdc, right + (left - right) / 6, top, NULL);
            //    LineTo(hdc, right + (left - right) / 6, bottom);
            //    MoveToEx(hdc, right + (left - right) / 6, top, NULL);
